...
function buildNav(activePage) {
  ...
  return `
  <nav id="nav">
    <a href="index.html" class="nav-logo"><img src="logo.png" alt="Reimagine FX" style="height:36px;width:auto;vertical-align:middle;margin-right:10px;">REIMAGINE FX</a>
...
function buildFooter() {
  ...
  <footer>
    <div class="footer-grid">
      <div>
        <div class="footer-logo"><img src="logo.png" alt="Reimagine FX" style="height:40px;width:auto;vertical-align:middle;margin-right:10px;">REIMAGINE FX</div>
